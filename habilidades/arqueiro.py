...
def ataque_normal_arqueiro(jogador, inimigo):
...
def ataque_flecha_de_impacto(jogador, inimigo):
    ...
    print("\n Você dispara uma flecha de impacto!")
...
def ataque_especial_chuva_de_flechas(jogador, inimigo):
    ...
    print("\n Você dispara uma chuva de flechas!")
